package com.example.hw4.services.impl;
...
import com.example.hw4.repositories.StockRepository;
import com.example.hw4.services.StockService;
...
public class StockServiceImpl implements StockService {
    ...
    @Override
    public List<StockData> getStockDataByDateRange(String startDate, String endDate) {
        return stockRepository.findByDateRange(startDate, endDate);
    }
}